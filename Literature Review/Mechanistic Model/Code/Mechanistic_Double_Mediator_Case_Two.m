...
r0 = [-0.03, -0.05]; % Basal growth rate (Per-species growth rate - constant)
...
title('Mechanistic Model - Case II','FontSize',14)
...
ylabel('[C1] and \color{red}{[C2]} \color{black} concentrations (µM)', ...
    'interpreter', 'tex')
ylim([10^0 10^6+1000000])
yticks([0 10^0 10^2 10^4 10^6])
