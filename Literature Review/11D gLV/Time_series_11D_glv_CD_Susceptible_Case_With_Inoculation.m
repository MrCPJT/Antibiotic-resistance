...
% Title
title('11D gLV Time Series - CD-Susceptible')

% Limits
ylim([0 26])

% Legend
leg = legend('','gLV', 'gLV + Perturbation','Location','northwest');
leg.ItemTokenSize = [21,9];
title(leg,'Model')

% Annotation
text(325, 10.75, 'Infected D','color', 'k')
text(80, 4.5, 'Uninfected B','color', 'k')
text(205, 17, 'CD Inoculation','color', [0.4 0.4 0.4])
