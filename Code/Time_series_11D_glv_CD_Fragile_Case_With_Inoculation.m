...
% Title
title('11D gLV Time Series - CD-fragile')

% Limits
ylim([0 26])

% Legend
leg = legend('', 'gLV', 'gLV + Perturbation','Location','east');
leg.ItemTokenSize = [21,9];
title(leg,'Model')

% Annotation
text(300, 11, 'Infected D','color', 'k')
text(100, 5, 'Uninfected E','color', 'k')
text(290, 23.5, 'Uninfected C','color', 'k')
text(205, 14, 'CD Inoculation','color', [0.4 0.4 0.4])
