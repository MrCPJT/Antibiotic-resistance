...
// Case 1d - Estimating all parameters simultaneously using co-culture
...
model {
  ...
  theta[4] ~ cauchy(1,0.01);    // Vague choice of priors
  theta[5] ~ cauchy(100000,1000); // Vague choice of priors
