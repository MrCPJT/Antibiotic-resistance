...
// Case 1c - For generating intra-interactivity and re-estimating inter-interactivity parameters
...
functions {
  real[] logisticgrowth(real t,
    ...
    real dudt = (1 - y[1]/theta[1] - y[2]/theta[3]) * y[1] * 1.01 ;
    real dvdt =  (1 - y[2]/theta[2] - y[1]/theta[4]) * y[2] * 0.87 ;
...
model {
  ...
  theta[1] ~ cauchy(100000,1000); // Vague choice of priors
